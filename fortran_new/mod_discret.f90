...
!============================================================================
	case (1)   ! u-momentum discretization
...
!----- coefficients (power law scheme) -----
		...
		as(i,j,k) = power_law_coeff_pos(ds, fs)
		ae(i,j,k) = power_law_coeff(de, fe)
		aw(i,j,k) = power_law_coeff_pos(dw, fw)
		at(i,j,k) = power_law_coeff(dt, ft)
		ab(i,j,k) = power_law_coeff_pos(db, fb)
...
!============================================================================
	case (2)   ! v-momentum discretization
...
!============================================================================
	case (3)   ! w-momentum discretization
...
!============================================================================
	case (4)   ! pressure correction discretization
...
!============================================================================
	case (5)   ! enthalpy discretization

...
!============================================================================
	case (4)   ! pressure correction boundary
...
!============================================================================
	case (5)   ! enthalpy boundary

!----- k=nk: top surface (radiation + convection)
	ahtoploss = 0.0
	do j = 2, njm1
	do i = 2, nim1
